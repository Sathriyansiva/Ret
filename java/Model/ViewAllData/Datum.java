...
public class Datum {
    ...
    @SerializedName("ProprietorOrPartner")
    private String mProprietorOrPartner;
    ...
    public String getDealsWithOEBrandOthersr() {
    ...
    public String getProprietorOrPartner() {
        return mProprietorOrPartner;
    }

    public void setProprietorOrPartner(String ProprietorOrPartner) {
        mProprietorOrPartner = ProprietorOrPartner;
    }
